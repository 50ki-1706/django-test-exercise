...
class TodoViewTestCase(TestCase):
    ...
    def test_index_get_order_post(self) -> None:
        task1: Task = Task(
            title="task1", due_at=timezone.make_aware(datetime(2024, 7, 1, 1))
        )
        task1.save()
        task2: Task = Task(
    ...
    def test_index_get_order_due(self) -> None:
        task1: Task = Task(
    ...
    def test_detail_get_success(self) -> None:
        task: Task = Task(
            title="task1", due_at=timezone.make_aware(datetime(2024, 7, 1))
        )
        task.save()
    ...
    def test_detail_get_fail(self) -> None:
        client = Client()
